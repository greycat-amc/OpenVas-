...
It is possible that at this stage some issues related to the target creation may occur. If this happens, please refer to the [Scan Configuration > Feed Owner Issue](07-troubleshooting.md) section to review how a problem related to the feed owner was identified and resolved.
